const PROJECT_DATA = [
  ...
  
  {
    ...
    previewImgUrl: 'previews/eyeball-forest-demo.png',
    category: 'interactive'
  },
  {
    title: 'Music Doodles',
  ...
  {
    title: 'AR Builders',
    description: 'Talk to CBRE Build\'s "Builders" in Augmented Reality! They\'ve lost some of their favorite items ... can you help? (Need to download & print the AR marker images in the code link below).',
    projectUrl: 'https://floored.github.io/ar-builders',
    codeUrl: 'https://github.com/sophiavanvalkenburg/ar-builders/',
    previewImgUrl: 'previews/ar-builders-demo.png',
    category: 'interactive'
  },
  {
    title: 'The Wrigglies',
    ...
    previewImgUrl: 'previews/wrigglies-demo.png',
    category: 'interactive'
  },
  {
    title: 'Rubiks Cube',
  ...
  /**** FINE ART */
  {
    projectUrl: '/img/fine-art/plum-and-pear.jpg',
    previewImgUrl: '/img/fine-art/plum-and-pear-sm.jpg',
    title: 'Plum and Pear',
    description: 'oil on shellacked paper.png',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/hacker-brian.jpg',
    previewImgUrl: '/img/fine-art/hacker-brian-sm.jpg',
    title: 'Brian the Hacker',
    description: 'charcoal pencil',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/girl-with-pearl-earring.jpg',
    previewImgUrl: '/img/fine-art/girl-with-pearl-earring-sm.jpg',
    title: 'Copy of \'Girl With A Pearl Earring\'',
    description: 'oil on canvas board',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/man-facing-away-with-staff.jpg',
    previewImgUrl: '/img/fine-art/man-facing-away-with-staff-sm.jpg',
    title: 'Man Facing Away',
    description: 'charcoal pencil',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/heavy-woman-portrait.jpg',
    previewImgUrl: '/img/fine-art/heavy-woman-portrait-sm.jpg',
    title: 'Portrait of Woman',
    description: 'charcoal pencil',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/delicata-squash.jpg',
    previewImgUrl: '/img/fine-art/delicata-squash-sm.jpg',
    title: 'Delicata Squash',
    description: 'watercolor',
    category: 'fine-art'
  },
 {
    projectUrl: '/img/fine-art/firefighter-dad.jpg',
    previewImgUrl: '/img/fine-art/firefighter-dad-sm.jpg',
    title: 'My Dad the Firefighter',
    description: 'graphite pencil',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/flask-and-spoon.jpg',
    previewImgUrl: '/img/fine-art/flask-and-spoon-sm.jpg',
    title: 'Flask and Spoon',
    description: 'watercolor',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/autumn-path.jpg',
    previewImgUrl: '/img/fine-art/autumn-path-sm.jpg',
    title: 'Autumn Path',
    description: 'digital (Photoshop)',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/eartha-kitt.jpg',
    previewImgUrl: '/img/fine-art/eartha-kitt-sm.jpg',
    title: 'Portrait of Eartha Kitt',
    description: 'watercolor',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/devin-portrait.jpg',
    previewImgUrl: '/img/fine-art/devin-portrait-sm.jpg',
    title: 'Portrait of Devin',
    description: 'oil on canvas',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/red-hat.jpg',
    previewImgUrl: '/img/fine-art/red-hat-sm.jpg',
    title: 'Portrait of Steve',
    description: 'oil on canvas board',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/elena-portrait.jpg',
    previewImgUrl: '/img/fine-art/elena-portrait-sm.jpg',
    title: 'Portrait of Elena',
    description: 'oil on canvas board',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/devin-sitting.jpg',
    previewImgUrl: '/img/fine-art/devin-sitting-sm.jpg',
    title: 'Portrait of Devin Sitting',
    description: 'charcoal',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/copper-cup-still-life.jpg',
    previewImgUrl: '/img/fine-art/copper-cup-still-life-sm.jpeg',
    title: 'Copper Cup',
    description: 'oil on canvas board',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/joe-portrait.jpg',
    previewImgUrl: '/img/fine-art/joe-portrait-sm.jpeg',
    title: 'Portrait of Joe',
    description: 'oil on canvas board',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/lilypad-pond.jpg',
    previewImgUrl: '/img/fine-art/lilypad-pond-sm.jpg',
    title: 'Lilypad Landscape',
    description: 'watercolor',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/man-with-staff.jpg',
    previewImgUrl: '/img/fine-art/man-with-staff-sm.jpg',
    title: 'Man with Staff',
    description: 'charcoal',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/woman-with-earring.jpg',
    previewImgUrl: '/img/fine-art/woman-with-earring-sm.jpeg',
    title: 'Woman with Earring',
    description: 'charcoal pencil',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/sitting-woman-in-ink.jpg',
    previewImgUrl: '/img/fine-art/sitting-woman-in-ink-sm.jpeg',
    title: 'Sitting Woman #2',
    description: 'ink wash',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/anatomical-woman.jpg',
    previewImgUrl: '/img/fine-art/anatomical-woman-sm.jpeg',
    title: 'Anatomy Study #1',
    description: 'pencil',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/darcy-standing.jpg',
    previewImgUrl: '/img/fine-art/darcy-standing-sm.jpeg',
    title: 'Darcy Standing',
    description: 'pencil',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/cadaver-hand-foot-study.jpg',
    previewImgUrl: '/img/fine-art/cadaver-hand-foot-study-sm.jpeg',
    title: 'Study of a Cadaver\'s Hand and Foot',
    description: 'graphite',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/mans-chest.jpg',
    previewImgUrl: '/img/fine-art/mans-chest-sm.jpeg',
    title: 'A Man\'s Chest',
    description: 'sanguine chalk',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/sitting-man-in-wax-resist.jpg',
    previewImgUrl: '/img/fine-art/sitting-man-in-wax-resist-sm.jpeg',
    title: 'Sitting Man #2',
    description: 'wax, ink, char-kole',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/gwb-cloudy-day.jpg',
    previewImgUrl: '/img/fine-art/gwb-cloudy-day-sm.jpeg',
    title: 'George Washington Bridge on a Cloudy Day',
    description: 'ink wash',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/womans-torso.jpg',
    previewImgUrl: '/img/fine-art/womans-torso-sm.jpeg',
    title: 'A Woman\'s Torso',
    description: 'sanguine chalk',
    category: 'fine-art'
  },
  {
    projectUrl: '/img/fine-art/reclining-woman.jpg',
    previewImgUrl: '/img/fine-art/reclining-woman-sm.jpeg',
